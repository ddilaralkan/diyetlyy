...
function CreatePatientPage() {
  ...
  // Asıl çalışan form state yapınız
  ...
  // Form gönderme ve yeni hasta oluşturma fonksiyonunuz (Yönlendirmeler korundu)
  async function handleSubmit(e?: React.FormEvent) {
    ...
    try {
      ...
      setFormMessage(getApiErrorMessage(error, "Danışan kaydedilemedi."));
    } finally {
      setIsLoading(false);
    }
  }

  // Tailwind temiz stil şablonları
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          >
            ...
            <span className="text-sm">Hastalara Dön</span>
          </button>
            ...
            <div className="space-y-1.5 pt-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onBlur={() => setFocusedField(null)}
                  disabled={isLoading}
                  className="w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl bg-gray-50/30 text-gray-900 placeholder:text-gray-400 transition-all duration-200 outline-none resize-none h-32 font-medium focus:border-[#557A2B] focus:bg-white focus:ring-4 focus:ring-[#557A2B]/5 disabled:opacity-60"
                />
              </div>
